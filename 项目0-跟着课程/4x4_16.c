...
char button(){
	...
	P1=0xFF;
	P1_2=0;
	if(P3_2==0){delay(2);while(P1_7==0);delay(2);KeyNumber=2;}
	if(P3_6==0){delay(2);while(P1_6==0);delay(2);KeyNumber=6;}
	if(P3_5==0){delay(2);while(P1_5==0);delay(2);KeyNumber=10;}
